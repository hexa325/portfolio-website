  ...
  return (
    <section id="about" className="section-padding section-container">
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <div>
          <p className="text-white/70 dark:text-white/70 text-black/70 mb-4">
          ...
          <p className="text-white/70 dark:text-white/70 text-black/70">
        ...
        <div className="bg-white/5 dark:bg-white/5 bg-black/5 rounded-2xl p-6 border border-white/10 dark:border-white/10 border-black/10">
          <h3 className="text-xl font-semibold mb-4">Quick Facts</h3>
          <ul className="space-y-3 text-white/70 dark:text-white/70 text-black/70">
