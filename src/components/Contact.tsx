  ...
  return (
    <section id="contact" className="section-padding section-container relative overflow-x-hidden">
      <div className="flex flex-col md:grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex flex-col items-center md:items-start text-center md:text-left w-full max-w-full px-4 md:px-0">
          ...
          <div className="space-y-4 md:space-y-6 mb-12 w-full max-w-md mx-auto md:mx-0">
            <a
              ...
              className="group flex items-center justify-between p-5 md:p-6 bg-white/50 dark:bg-white/5 rounded-2xl border border-black/5 dark:border-white/5 hover:border-black/20 dark:hover:border-white/20 transition-colors overflow-hidden"
            >
            ...
            <a
              ...
              className="group flex items-center justify-between p-5 md:p-6 bg-white/50 dark:bg-white/5 rounded-2xl border border-black/5 dark:border-white/5 hover:border-black/20 dark:hover:border-white/20 transition-colors"
            >
        ...
        <div className="bg-white/80 dark:bg-black/60 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 border border-black/5 dark:border-white/5 shadow-2xl shadow-black/5 dark:shadow-black transition-colors duration-500 [transform:translateZ(0)]">
          <ContactForm />
        </div>
      </div>
    </section>
