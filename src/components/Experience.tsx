  ...
  return (
    <section id="experience" className="section-padding section-container">
      ...
      <div className="space-y-8">
        <div className="border-l-2 border-white/20 dark:border-white/20 border-black/20 pl-6">
          <span className="text-sm text-white/50 dark:text-white/50 text-black/50">
            2024 — Present
          </span>
          <h3 className="text-xl font-semibold mt-2">Senior Developer</h3>
          <p className="text-blue-400">Company Name</p>
          <p className="text-white/60 dark:text-white/60 text-black/60 mt-2">
